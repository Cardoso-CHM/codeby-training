 ...
 */
declare function GalleryItem({ item, displayMode, position, listName, summary, CustomSummary, }: GalleryItemProps): JSX.Element;
declare const _default: React.MemoExoticComponent<typeof GalleryItem>;

...
declare function SliderLayout({ totalItems, infinite, showNavigationArrows, showPaginationDots, usePagination, fullWidth, arrowSize, children, centerMode, itemsPerPage, classes, ...contextProps }: PropsWithChildren<SliderLayoutProps & SliderLayoutSiteEditorProps & Props>): JSX.Element;
